...
print("\n[!] Machine started. started to learning from JSONL (take a while)...\n")
...
print("\n[v] Training process done!")

print("\nResult from Machine: ")
context = torch.tensor([[stoi['I']]], dtype=torch.long)
hasil = model.generate(context, max_new_tokens=900)[0].tolist()
print(decode(hasil))